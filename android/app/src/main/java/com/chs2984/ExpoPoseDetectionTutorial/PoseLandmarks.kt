...
class PoseLandmarks(reactContext: ReactApplicationContext): ReactContextBaseJavaModule(reactContext) {
    ...
    @ReactMethod
    fun initModel() {
        Log.d("PoseLandmarks", "initModel() called")
        
        if (PoseLandmarkerHolder.poseLandmarker != null) {
            Log.d("PoseLandmarks", "Model already initialized")
        ...
        Log.d("PoseLandmarks", "Starting model initialization...")
        ...
        var resultListener = OutputHandler.ResultListener{ result: PoseLandmarkerResult,  inputImage: MPImage ->
            ...
            params.putInt("frameWidth", inputImage.width)
            params.putInt("frameHeight", inputImage.height)
